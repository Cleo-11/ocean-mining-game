...
export function isStorageMaxed(resources: PlayerResources, stats: PlayerStats): boolean {
  return (
    resources.nickel >= stats.maxCapacity.nickel &&
    resources.cobalt >= stats.maxCapacity.cobalt &&
    resources.copper >= stats.maxCapacity.copper &&
    resources.manganese >= stats.maxCapacity.manganese
  )
}
...
export function getStorageStatus(
  ...
  return {
    ...
    totalUsed,
    totalCapacity,
    percentage: Math.round((totalUsed / totalCapacity) * 100),
  }
}
